...
image::images/ready-set-code.jpg["Ready...Set...Code!", width=100%]
...
image::images/country.png["Country content type", width=100]
...
image::images/city.png["City content type", width=100]
...
image::images/app-config.jpg["Myapp config", width=100%]
...
image::images/city-data-table.png["Sample city data", width=100%]
...
image::images/city-list.png["City list", width=100%]
...
image::images/city-list-config.jpg["City list", width=100%]
